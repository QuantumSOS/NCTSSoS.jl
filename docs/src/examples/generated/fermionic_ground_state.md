...
````
N = 4:  SDP = -1.4142135595767416,  exact = -1.414213562373095,  gap = 2.79635337108175e-9
...
````
N = 6:  first = -2.0375379441974895,  refined = -1.7320508073230125,  exact = -1.7320508075688772
  gap after refinement: 2.4586466196296897e-10
...
````
N = 8:  first = -2.744206530623572,  refined = -2.6131259295056477,  exact = -2.6131259297527527
  gap after refinement: 2.471050031260802e-10
