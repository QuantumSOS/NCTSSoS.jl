```@meta
EditURL = "../literate/h4_chain_energy_benchmark.jl"
```
...
````
System: H₄ chain, Nk=2, active space [4,8]
Full system: 32 spin-orbital modes
k=0 sector:  16 spin-orbital modes
...
````
k=0 Hamiltonian: 1984 terms on 16 modes
...
````
After Hermitianization: 1984 terms
...
````
N↑ modes: 1–8 (spin-up)
N↓ modes: 9–16 (spin-down)
Target sector: N↑ = 2, N↓ = 2
...
Solving order-2 SDP (16 modes, k=0, canonical sector) …
Order-2 electronic energy (first pass): -3.6611870442 Ha
...
````
Refining …
Order-2 electronic energy (refined):    -3.6611883935 Ha
...
HF active-space electronic energy (all k): -3.390265 Ha
HF constant shift:                         1.276913 Ha
HF total energy / cell:                    -2.113352 Ha
