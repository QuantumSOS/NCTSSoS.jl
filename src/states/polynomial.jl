"""
    StatePolynomial{C<:Number, ST<:StateType, A<:MonoidAlgebra, T<:Integer}
...
"""
struct StatePolynomial{C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer} <: AbstractPolynomial{C}
    coeffs::Vector{C}
...
"""
function Base.zero(::Type{StatePolynomial{C,ST,A,T}}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.zero(::StatePolynomial{C,ST,A,T}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.one(::Type{StatePolynomial{C,ST,A,T}}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.one(::StatePolynomial{C,ST,A,T}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.:(-)(sw::StateWord{ST,A,T}) where {ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.:(-)(sp::StatePolynomial{C,ST,A,T}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.:(*)(c::Number, sp::StatePolynomial{C,ST,A,T}) where {C<:Number,ST<:StateType,A<:MonoidAlgebra,T<:Integer}
...
"""
function Base.:(+)(c::Number, sw::StateWord{ST,A,T}) where {ST<:StateType,A<:MonoidAlgebra,T<:Integer}
