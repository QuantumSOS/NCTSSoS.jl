...
````
Case 1 (sweet spot):  SDP = -3.0000000000733977,  exact = -3.0000000000000004,  gap = 7.339728824717895e-11
...
````
Case 2 (trivial):    SDP = -12.503891585577952,  exact = -12.503892,  gap = 2.8451538014451216e-8
...
````
Case 3 (asymmetric): SDP = -2.422078451443316,  exact = -2.422078,  gap = 2.7631230636870896e-12
...
````
Case 4 (hopping):   SDP = -2.236067977544464,  exact = -2.236068,  gap = 4.46744863324966e-11
...
````
Pauli XX chain:  SDP = -3.0000000040682715,  fermionic sweet spot = -3.0000000000000004
