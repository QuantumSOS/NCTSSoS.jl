# Phase 1 — H₄ periodic moment/SOS solve via libsdp + BPSDP.jl (ARCHIVED)

> **Status: COMPLETED.** Archived from `TASK.md` when the project moved to Phase 2.
> Phase 2 plan: `PHASE2_PLAN.md`.

The content below is the original Phase 1 task context, preserved verbatim so the
file-roundtrip recipe and server environment notes remain recoverable.
