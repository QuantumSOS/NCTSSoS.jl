```@meta
EditURL = "../literate/h4_periodic_incomplete_momentum_basis.jl"
```
...
````
dense order-2 basis size = 2081
custom basis size        = 529
pair sector K=0 count    = 240
pair sector K=1 count    = 256
...
electronic lower bound    = -6.366838786026 Ha
total lower bound (+shift)= -5.089926089471 Ha
HF active-space energy    = -3.390264821340 Ha
HF total / cell           = -2.113352124784 Ha
figure V2RDM / cell       = -2.188000000000 Ha
unique moment variables   = 25087
