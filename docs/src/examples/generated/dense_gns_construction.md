```@meta
EditURL = "../literate/dense_gns_construction.jl"
```
...
7×7 Matrix{Float64}:
  1.00001    0.499907   0.500102   1.0483  -0.5483  -0.5483   1.0484
  0.499907   1.0483    -0.548283   1.0627  -0.0144  -0.609    0.0606
  0.500102  -0.548283   1.04827   -0.0144  -0.534    0.0606   0.9878
  1.0483     1.0627    -0.0144     1.4622  -0.3995  -0.8006   0.7863
 -0.5483    -0.0144    -0.534     -0.3995   0.3852   0.1917  -0.7256
 -0.5483    -0.609      0.0606    -0.8006   0.1917   0.4411  -0.3804
  1.0484     0.0606     0.9878     0.7863  -0.7256  -0.3804   1.3682
````
...
````
NCTSSoS.GNSFlatnessReport(2, 1, 2, 2, true, 0.1, 1.0e-6, 3, 0.00020863263034021085)
````
...
````
(theta_1 = [0.0, 1.0], theta_2 = [0.9999, -0.9999])
````
...
````
(theta_1 = [0.0 0.711; 1.0 0.6747], theta_2 = [0.9999 -0.3386; -0.9999 -0.4195])
````
...
````
(theta_1 = [0.4999 -0.8935; -0.8935 0.1748], theta_2 = [0.5001 0.8934; 0.8934 0.0804])
````
...
````
Objective: -1.0000000000769054
Correlative Sparsity (UnipotentAlgebra): 

   maximum clique size: 1
   number of cliques: 1
   Clique 1: 
       Variables: [:u₁]
       Bases length: 2
...
Term Sparsity:
Clique 1:
   Moment Matrix Block Sizes: [2]
   Moment Matrix:
Number of Activated supp:   2
Number of Bases Activated in each sub-block[2]

   Localizing Matrix:
Unique Moment Matrix Elements: 2
Dense Moment Data: true
...
````
NCTSSoS.GNSFlatnessReport(1, 0, 1, 1, true, 1.0e-7, 1.0e-7, 1, 0.0)
````
