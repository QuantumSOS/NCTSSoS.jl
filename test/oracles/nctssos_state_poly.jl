...
# API: pstateopt_first for state polynomial optimization
#      Support format: [[w1], [w2]] means ς(w1)·ς(w2)
...
print_header("State Polynomial 7.2.0 (CHSH)")
...
results_7_2_0 = map(STATE_7_2_0_VARIANTS) do v
    ...
    opt, data = pstateopt_first(supp_7_2_0, coe_7_2_0, 4, v.order;
        vargroup=[2, 2],
